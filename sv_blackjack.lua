...
function tryTakeChips(source,amount)
    ...
    if Player ~= nil then
		 ...
		 if Chips ~= nil then
             ...
             TriggerClientEvent('QBCore:Notify', source, 'You dont have any chips', 'error')
		 	return false
		 end
        --TriggerClientEvent('QBCore:Notify', source, 'Blackjack currently disabled as there is a bug.', 'error')
       -- return false
    end
end
